...
export default function Layout() {
  ...
  return (
    <div className="site-shell">
      <header className="header">
        ...
        <div className="header-actions">
          ...
          {user ? (
            ...
            <Link className="icon-btn" to="/login" aria-label="Sign in"><UserRound /></Link>
          )}
        </div>
      </header>
      <main><Outlet /></main>
      <footer>
        <div>
          <span className="brand light">ToQa.</span>
          <p>Considered pieces for everyday grace.</p>
        </div>
        <p>Single-store demo / Egypt / 2026</p>
      </footer>
    </div>
  );
}
